...
frontend-release: frontend-build
	docker tag finex.io/app/monorepo/frontend:latest registry.gitlab.com/finex.io/app/monorepo/frontend:1.7.0
...
frontend-publish: frontend-release
	docker push registry.gitlab.com/finex.io/app/monorepo/frontend:1.7.0
