...
begin
  ...
  begin
    ...
    insert 
      into core$.session (id_session, token, id_user, last_access_time, ip, requests_count, id_project)
    select id_session, token, id_user, last_access_time, ip, requests_count, id_project
      from dblink('select id_session, token, id_user, last_access_time, ip, requests_count, id_project from core$.Session where Id_User = ' || vId_User::text) 
