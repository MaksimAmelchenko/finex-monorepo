// it is react-div-100vh@0.5.6 (https://github.com/mvasin/react-div-100vh)
// but function 'measureHeight' is changed due to https://github.com/mvasin/react-div-100vh/issues/30

import React, { useState, useEffect, HTMLAttributes } from 'react';

let warned = false;

export default function Div100vh({ style = {}, ...other }: Omit<HTMLAttributes<HTMLDivElement>, 'css'>): JSX.Element {
