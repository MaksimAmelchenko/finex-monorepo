module.exports = {
  ...
  CashFlowItem: {
    ...
    'A not confirmed transaction will be marked in a journal yellow color_ The overdue and not confirmed operation will be marked red_':
      'Неподтвержденная транзакция будет отмечена в журнале желтым цветом. Просроченная и не подтвержденная операция будет отмечена красным цветом.',
  ...
  ResetPassword: {
    'Please enter E-mail address': 'Укажите E-mail',
    'Please enter a valid E-mail address': 'Проверьте, правильно ли введён E-mail',
    'Forgot your Password?': 'Забыли пароль?',
    'User not found': 'Пользователь не найден',
    'To reset you password enter your E-mail': 'Что бы сменить пароль, введите адрес электронной почты',
    'E-mail': 'E-mail',
    Next: 'Продолжить',
  },
